          ...
          <div class="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
            ...
            <div class="sticky top-0">
                ...
                <div class="prose max-w-none">
                  <p>
                    <ul>
                      ...
                      <li>
                        • Cinematic mode adds shallow depth of field and shifts
                        focus automatically in your videos
                      </li>
                      <li>
                      ...
                      <li>
                        • 12MP TrueDepth front camera with Night mode, 4K Dolby
              ...
              <div>
                ...
                <div className="flex justify-between border-2 border-gray-200 rounded items-center my-2">
                  <p class="w-3/2 px-4 py-2 font-medium text-left">
                    Siddhesh Kulthe
                  </p>
                  <div className="flex items-center text-xl px-4 py-2">
                    <h1 className="mx-2">₹</h1>
                    <h1 className="text-2xl font-bold">59,900</h1>
                  </div>
                </div>
                <div className="flex justify-between border-2 border-gray-200 rounded items-center my-2">
                  <p class="w-3/2 px-4 py-2 font-medium text-left">
